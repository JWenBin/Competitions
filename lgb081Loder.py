...
sample_file="D:\\data\\input\\tl\\sample.csv"
TRAIN_FILE = "D:\\data\\input\\tl\\train.csv"
TEST_FILE = "D:\\data\\input\\tl\\test.csv"
...
# train_df.to_csv(input_dir+'train_df', index=False, header=True)
# test_df.to_csv(input_dir+'test_df', index=False, header=True)
# train_x.to_csv(input_dir+'train_x', index=False, header=True)
# pd.DataFrame(train_y) .to_csv(input_dir+'train_y', index=False, header=True)
# val_x.to_csv(input_dir+'val_x', index=False, header=True)
# pd.DataFrame(val_y).to_csv(input_dir+'val_y', index=False, header=True)
# train_df.to_csv(input_dir+'train_df', index=False, header=True)
# pd.DataFrame(labels).to_csv(input_dir+'labels', index=False, header=True)
# test_df.to_csv(input_dir+'test_df', index=False, header=True)

# labels=pd.read_csv(input_dir+'labels')['0'].values
# train_df = pd.read_csv(input_dir+'train_df')
# test_df = pd.read_csv(input_dir+'test_df')
# train_x = pd.read_csv(input_dir+'train_x')
# print(train_x.head(5))
# train_y = pd.read_csv(input_dir+'train_y')['0'].values
# val_x = pd.read_csv(input_dir+'val_x')
# val_y = pd.read_csv(input_dir+'val_y')['0'].values

# train_df.to_pickle(input_dir+'train_df')
# test_df.to_pickle(input_dir+'test_df')
# train_x.to_pickle(input_dir+'train_x')
# pd.DataFrame(train_y) .to_pickle(input_dir+'train_y')
# val_x.to_pickle(input_dir+'val_x')
# pd.DataFrame(val_y).to_pickle(input_dir+'val_y')
# train_df.to_pickle(input_dir+'train_df')
# pd.DataFrame(labels).to_pickle(input_dir+'labels')
# test_df.to_pickle(input_dir+'test_df')
#
labels=pd.read_pickle(input_dir+'labels').head(1000000)
labels.columns=list('y')
labels=labels['y'].values
# train_df = pd.read_pickle(input_dir+'train_df')
# test_df = pd.read_pickle(input_dir+'test_df')
train_x = pd.read_pickle(input_dir+'train_x').head(1000000)
print(train_x.head(5))
train_y = pd.read_pickle(input_dir+'train_y').head(1000000)
train_y.columns=list('y')
train_y=train_y['y'].values
val_x = pd.read_pickle(input_dir+'val_x').head(1000000)
val_y = pd.read_pickle(input_dir+'val_y').head(1000000)
val_y.columns=list('y')
val_y=val_y['y'].values

cate_cols = [    'deviceid', 'newsid', 'pos', 'app_version', 'device_vendor',
    'netmodel', 'osversion', 'device_version', 'lng', 'lat', 'lng_lat']
...
# pd.DataFrame(labels).to_pickle(input_dir+'labels')
# test_df.to_pickle(input_dir+'test_df')
# clf.booster_.save_model(input_dir+'mode.txt')
