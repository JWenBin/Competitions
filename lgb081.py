...
# test_df.to_pickle(input_dir+'test_df')
#
# labels=pd.read_pickle(input_dir+'labels')['0'].values
# train_df = pd.read_pickle(input_dir+'train_df')
# test_df = pd.read_pickle(input_dir+'test_df')
# train_x = pd.read_pickle(input_dir+'train_x')
# print(train_x.head(5))
# train_y = pd.read_pickle(input_dir+'train_y')['0'].values
# val_x = pd.read_pickle(input_dir+'val_x')
# val_y = pd.read_pickle(input_dir+'val_y')['0'].values
